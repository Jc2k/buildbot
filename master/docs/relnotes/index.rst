...
* TODO. New SetSlaveInfo step.

* TODO. Interpolate("%(slave:XXXX)s")
...
* A new mode ``force`` was added to the MailNotifier for allowing mail to always be sent for force builds (:bb:pull: `1097`).
...
* TODO. Add slave pausing and unpausing.

* TODO. MSBuild changes.
